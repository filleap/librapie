...
// Liste des livres commandes par une personne
	...
	if($session){
		...
		$query = "SELECT * FROM ".$annee."_APIE_Livres WHERE Sel='1' ORDER BY Suppr, Categorie, Titre";
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en_FR" xml:lang="en_FR">
    ...
    <script type="text/javascript" src="./jslib/tablesort.js"></script>
		...
		<title>LibrAPIE - Livres de la sélection de l'année <?php print($annee) ?></title>
  </head>
  <body>
		<div class="container" id="content" class="content">
			...
			<?php
				if(!$session){
					print("<div id='listeLivresSelection' hidden>");
				} else {
					print("<div id='listeLivresSelection'>");
				}
			?>
				...
				<div>
				    ...
				    <caption>Liste des livres de la sélection de l'année <?php print($annee) ?></caption>
						<tr>
							<th>Choix</th>
							<th>Couverture</th>
							<th>ISBN-13</th>
